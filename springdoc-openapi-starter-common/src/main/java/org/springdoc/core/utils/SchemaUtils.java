...
public class SchemaUtils {
     ...
     * @return the boolean
     */
    public static boolean swaggerVisible(@Nullable io.swagger.v3.oas.annotations.media.Schema schema, @Nullable Parameter parameter) {
        if (parameter != null) {
    ...
    /**
     * Is swagger required. it may return {@code null} if not specified require value or mode
     *
     * @param schema    the schema
     * @param parameter the parameter
     ...
     */
    @Nullable
    public static Boolean swaggerRequired(@Nullable io.swagger.v3.oas.annotations.media.Schema schema, @Nullable Parameter parameter) {
        if (parameter != null && parameter.required()) {
            return true;
        }
        if (schema != null) {
            if (schema.required() || schema.requiredMode() == io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED) {
                return true;
            }
    ...
    /**
     * Is field nullable.
     * java default is nullable {@link SchemaUtils#JAVA_FIELD_NULLABLE_DEFAULT}
     *
     ...
     * @see io.swagger.v3.oas.annotations.media.Schema#requiredMode()
     */
    public static boolean fieldRequired(Field field, @Nullable io.swagger.v3.oas.annotations.media.Schema schema, @Nullable Parameter parameter) {
     ...
     * the annotation order effects the result of the validation.
     *
     * @param schema      the schema
