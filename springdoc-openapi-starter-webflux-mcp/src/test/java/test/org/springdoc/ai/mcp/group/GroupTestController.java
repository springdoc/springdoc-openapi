...
/**
 * Test controllers with different @Tag annotations for group testing (reactive).
 *
 * @author bnasslahsen
 */
public class GroupTestController {
	...
	public static class UserController {
		...
		public Flux<Map<String, String>> listUsers() {
			return Flux.just(Map.of("id", "1", "name", "Alice"));
		}
		...
		public Mono<Map<String, String>> getUserById(@PathVariable String id) {
			return Mono.just(Map.of("id", id, "name", "Alice"));
		}
	...
	public static class ProductController {
		...
		public Mono<Map<String, String>> createProduct(@RequestBody Map<String, String> product) {
