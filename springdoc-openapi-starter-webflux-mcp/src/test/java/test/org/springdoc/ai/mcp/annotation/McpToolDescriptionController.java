...
/**
 * Test controller with {@link McpToolDescription} annotations for reactive context.
 *
 * @author bnasslahsen
 */
@RestController
public class McpToolDescriptionController {
	...
	public Flux<Map<String, String>> listOrders() {
		return Flux.just(Map.of("id", "1", "status", "pending"));
	}
	...
	public Mono<Map<String, String>> getOrderById(@PathVariable String id) {
		return Mono.just(Map.of("id", id, "status", "pending"));
	}
	...
	public Mono<Map<String, String>> createOrder(@RequestBody Map<String, String> order) {
