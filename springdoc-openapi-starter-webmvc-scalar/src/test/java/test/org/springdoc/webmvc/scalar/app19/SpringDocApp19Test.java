...
@TestPropertySource(properties = "scalar.path="+ SpringDocApp19Test.SCALAR_PATH)
public class SpringDocApp19Test extends AbstractCommonTest {

	static final String SCALAR_PATH = "/" ;
