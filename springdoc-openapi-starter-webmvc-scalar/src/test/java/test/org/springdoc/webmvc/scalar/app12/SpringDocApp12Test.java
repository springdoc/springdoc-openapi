...
package test.org.springdoc.webmvc.scalar.app12;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
		properties = { "management.endpoints.web.exposure.include=*",
				...
				"management.server.base-path="+ SpringDocApp12Test.BASE_PATH,
				"management.endpoints.web.base-path="+ SpringDocApp12Test.ACTUATOR_BASE_PATH })
class SpringDocApp12Test extends AbstractSpringDocActuatorTest {
	...
	void checkNotFound() throws Exception {
		mockMvc.perform(get(ACTUATOR_BASE_PATH  + SCALAR_DEFAULT_PATH))
