...
package test.org.springdoc.webmvc.scalar.app6;
...
@TestPropertySource(properties = "server.servlet.context-path=" + SpringDocApp6Test.CONTEXT_PATH)
public class SpringDocApp6Test extends AbstractCommonTest {
