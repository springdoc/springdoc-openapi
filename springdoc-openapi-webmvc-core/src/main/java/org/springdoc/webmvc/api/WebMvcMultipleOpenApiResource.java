 ...
 * @author bnasslahsen
 */
public abstract class WebMvcMultipleOpenApiResource implements InitializingBean {
	 ...
	 */
	private Map<String, WebMvcOpenApiResource> groupedOpenApiResources;
	 ...
	 */
	public WebMvcMultipleOpenApiResource(List<GroupedOpenApi> groupedOpenApis,
	...
	private WebMvcOpenApiResource buildWebMvcOpenApiResource(GroupedOpenApi item) {
	 ...
	 */
	protected WebMvcOpenApiResource getOpenApiResourceOrThrow(String group) {
		WebMvcOpenApiResource openApiResource = groupedOpenApiResources.get(group);
