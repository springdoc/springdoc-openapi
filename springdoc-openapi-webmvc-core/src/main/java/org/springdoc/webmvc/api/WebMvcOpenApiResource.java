 ...
 * @author bnasslahsen
 */
public abstract class WebMvcOpenApiResource extends AbstractOpenApiResource {
	 ...
	 */
	public WebMvcOpenApiResource(String groupName, ObjectFactory<OpenAPIService> openAPIBuilderObjectFactory, AbstractRequestService requestBuilder,
	 ...
	 * @param repositoryRestResourceProvider the repository rest resource provider
	 */
	public WebMvcOpenApiResource(ObjectFactory<OpenAPIService> openAPIBuilderObjectFactory, AbstractRequestService requestBuilder,
			GenericResponseService responseBuilder, OperationService operationParser,
			RequestMappingInfoHandlerMapping requestMappingHandlerMapping,
			Optional<ActuatorProvider> actuatorProvider,
			Optional<List<OperationCustomizer>> operationCustomizers,
