...
@TestPropertySource(properties = {
		...
		"springdoc.group-configs[1].packages-to-scan=test.org.springdoc.api.app106.api.user",
		...
		"springdoc.group-configs[3].packages-to-scan=test.org.springdoc.api.app106.api.user,test.org.springdoc.api.app106.api.store",
})
