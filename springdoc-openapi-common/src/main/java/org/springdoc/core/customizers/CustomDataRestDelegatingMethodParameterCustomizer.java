...
public class CustomDataRestDelegatingMethodParameterCustomizer implements DelegatingMethodParameterCustomizer {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(CustomDataRestDelegatingMethodParameterCustomizer.class);
	 ...
	 * properties provider
	 * @param optionalRepositoryRestConfigurationProvider the optional repository rest
	 * configuration provider
	 */
	public CustomDataRestDelegatingMethodParameterCustomizer(
