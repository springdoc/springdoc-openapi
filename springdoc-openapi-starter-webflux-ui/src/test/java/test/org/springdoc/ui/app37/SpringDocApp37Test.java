...
@SpringBootTest(webEnvironment = WebEnvironment.DEFINED_PORT,
		properties = { "server.port=9237" })
class SpringDocApp37Test extends AbstractCommonTest {
	...
	void testIndex() throws Exception {
		HttpStatusCode httpStatusMono = webClient.get().uri("/swagger-ui.html")
		...
		String expected = getContent("results/app37.json");
