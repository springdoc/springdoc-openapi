...
package test.org.springdoc.webflux.scalar.app4;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
		properties = { "management.endpoints.web.exposure.include=*",
				...
				"management.server.port=9592",
				"management.endpoints.web.base-path="+ SpringDocApp4Test.ACTUATOR_BASE_PATH })
class SpringDocApp4Test extends AbstractSpringDocActuatorTest {
