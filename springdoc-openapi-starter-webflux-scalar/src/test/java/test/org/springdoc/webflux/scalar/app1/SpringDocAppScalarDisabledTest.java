...
package test.org.springdoc.webflux.scalar.app1;
...
public class SpringDocAppScalarDisabledTest extends AbstractCommonTest {

	@Test
	void checkNotFound() {
		webTestClient.get().uri(SCALAR_DEFAULT_PATH).exchange()
